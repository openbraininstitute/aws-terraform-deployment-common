...
moved {
  from = module.public_alb.aws_lb.alb
  to   = module.public_alb_basic.aws_lb.alb
}
moved {
  from = module.public_alb.aws_lb_listener.http
  to   = module.public_alb_config.aws_lb_listener.http
}
moved {
  from = module.public_alb.aws_lb_listener.https
  to   = module.public_alb_config.aws_lb_listener.https
}
moved {
  from = module.public_alb.aws_lb_listener_certificate.primary_www_domain_certificate
  to   = module.public_alb_config.aws_lb_listener_certificate.primary_www_domain_certificate
}
moved {
  from = module.public_alb.aws_lb_listener_certificate.secondary_root_domain_certificate
  to   = module.public_alb_config.aws_lb_listener_certificate.secondary_root_domain_certificate
}
moved {
  from = module.public_alb.aws_lb_listener_certificate.secondary_www_domain_certificate
  to   = module.public_alb_config.aws_lb_listener_certificate.secondary_www_domain_certificate
}
moved {
  from = module.public_alb.aws_lb_listener_rule.domain_redirect
  to   = module.public_alb_config.aws_lb_listener_rule.domain_redirect
}
moved {
  from = module.public_alb.aws_security_group.alb
  to   = module.public_alb_basic.aws_security_group.alb
}
moved {
  from = module.public_alb.aws_vpc_security_group_egress_rule.alb_allow_everything_outgoing
  to   = module.public_alb_basic.aws_vpc_security_group_egress_rule.alb_allow_everything_outgoing
}
moved {
  from = module.public_alb.aws_vpc_security_group_ingress_rule.alb_allow_http_all
  to   = module.public_alb_basic.aws_vpc_security_group_ingress_rule.alb_allow_http_all
}
moved {
  from = module.public_alb.aws_vpc_security_group_ingress_rule.alb_allow_https_all
  to   = module.public_alb_basic.aws_vpc_security_group_ingress_rule.alb_allow_https_all
}
moved {
  from = module.public_alb.aws_vpc_security_group_ingress_rule.alb_allow_lb_internal
  to   = module.public_alb_basic.aws_vpc_security_group_ingress_rule.alb_allow_lb_internal
}
